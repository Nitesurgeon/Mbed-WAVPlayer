...
// with DC offset so it can be written to the DAC.
          ...
          DAC_fifo[DAC_wptr]=((volume)* dac_data)>>4; //volume modified
...
void wave_player::setPlaying(bool value)
{
    playing = value;    
}

bool wave_player::getPlaying()
{
    return playing;
}

void wave_player::setStop(bool value)
{
    stop = value;
}

bool wave_player::getStop()
{
    return stop;
}

void wave_player::volUp()
{
    if (volume == 16)
        volume = 16;
    else
...
int wave_player::getVol()
{
    return volume;
}

void wave_player::setVol(int value)
{
    volume = value;
}

void wave_player::incrementSlice()
{
    slice+=1;
}

void wave_player::decrementSlice()
{
    slice-=1;
}
